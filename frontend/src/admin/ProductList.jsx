...
// import { deleteProduct } from '../../../backend/src/controllers/productController';
...
//                             <Link to={`/admin/products/edit/${product._id}`} className=' text-blue-500 hover:underline px-4 py-2'>
//                                 Edit
//                             </Link>
//                             <button onClick={()=>deleteProduct(product._id)} className='text-red-500 hover:underline'>
//                                 Delete
//                             </button>
//                         </td>
//                     </tr>
